...
export const OrgSidebar = () => {
    ...
    const isFavorites = favorites === "true"; // Convert to boolean

    console.log("Favorites param:", favorites);

    return (
        <div className="hidden lg:flex flex-col space-y-6 w-[206px] pl-5 pt-5 bg-transparent">
            <Link href="/">
